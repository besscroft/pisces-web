<template>
		...
		<el-container style="height: 100%">
			<el-header style="margin-top: 12px">
				<el-card class="box-card">
					...
					<el-button style="margin-left: 4px" type="primary" @click="handleAddResourceCategory" :icon="Pointer">
						新增资源类别
					</el-button>
				</el-card>
			</el-header>
			<el-main>
				<el-card class="box-card">
					<el-table v-loading="loading" border :data="resourceCategoryList" style="width: 100%">
	...
	<!-- 新增资源类别弹窗 -->
	<el-dialog v-model="dialogAddResourceCategoryVisible" title="新增资源类别" width="30%" :before-close="handleAddResourceCategoryClose">
		<el-form :model="addResourceCategoryRuleForm" ref="formAddResourceCategoryRef" label-width="120px" class="demo-ruleForm">
	...
	>
		<el-form :model="updateResourceCategoryRuleForm" ref="formUpdateResourceCategoryRef" label-width="120px" class="demo-ruleForm">
			<el-form-item label="资源类别名称" prop="name">
...
const addResourceCategoryRuleForm = reactive<ResourceCategory.AddResourceCategoryRequestData>({
	/** 资源类别名称 */
	categoryName: '',
	/** 资源类别描述 */
	description: '',
...
const updateResourceCategoryRuleForm = reactive<ResourceCategory.UpdateResourceCategoryRequestData>({
	/** 资源类别 id */
