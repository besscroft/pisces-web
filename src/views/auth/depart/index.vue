<template>
		...
		<el-container style="height: 100%">
			<el-header style="margin-top: 12px">
				<el-card class="box-card">
					...
					<el-button style="margin-left: 4px" type="primary" @click="handleAddDepart" :icon="Pointer">
						新增部门
					</el-button>
				</el-card>
			</el-header>
			<el-main>
				<el-card class="box-card">
					<el-table v-loading="loading" row-key="id" border :data="departList" style="width: 100%" default-expand-all>
	...
	<!-- 新增部门弹窗 -->
	<el-dialog v-model="dialogAddDepartVisible" title="新增部门" width="30%" :before-close="handleAddDepartClose">
		<el-form :model="addDepartRuleForm" ref="formAddDepartRef" label-width="120px" class="demo-ruleForm">
	...
	<!-- 修改部门弹窗 -->
	<el-dialog v-model="dialogUpdateDepartVisible" title="修改部门" width="30%" :before-close="handleUpdateDepartClose">
		<el-form :model="updateDepartRuleForm" ref="formUpdateDepartRef" label-width="120px" class="demo-ruleForm">
			<el-form-item label="父级部门名称" prop="categoryId">
...
const addDepartRuleForm = reactive<Depart.AddDepartRequestData>({
	/** 上级 id */
	parentId: undefined,
	/** 部门名称 */
	name: '',
...
const updateDepartRuleForm = reactive<Depart.UpdateDepartRequestData>({
	/** 部门 id */
	departId: undefined,
	/** 上级 id */
	parentId: undefined,
