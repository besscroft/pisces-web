<template>
		...
		<el-container style="height: 100%">
			<el-header style="margin-top: 12px">
				<el-card class="box-card">
					...
					<el-button style="margin-left: 4px" type="primary" @click="handleAddWhite" :icon="Pointer">
						新增白名单
					</el-button>
				</el-card>
			</el-header>
			<el-main>
				<el-card class="box-card">
					<el-table v-loading="loading" row-key="id" border :data="whiteList" style="width: 100%" default-expand-all>
	...
	<!-- 新增白名单弹窗 -->
	<el-dialog v-model="dialogAddWhiteVisible" title="新增白名单" width="30%" :before-close="handleAddWhiteClose">
		<el-form :model="addWhiteRuleForm" ref="formAddWhiteRef" label-width="120px" class="demo-ruleForm">
	...
	<!-- 修改白名单弹窗 -->
	<el-dialog v-model="dialogUpdateWhiteVisible" title="修改白名单" width="30%" :before-close="handleUpdateWhiteClose">
		<el-form :model="updateWhiteRuleForm" ref="formUpdateWhiteRef" label-width="120px" class="demo-ruleForm">
			<el-form-item label="白名单规则名称" prop="title">
...
const addWhiteRuleForm = reactive<White.AddWhiteRequestData>({
	/** 白名单规则名称 */
	title: '',
	/** 白名单规则地址 */
	path: '',
...
const updateWhiteRuleForm = reactive<White.UpdateWhiteRequestData>({
	/** 白名单 id */
	whiteId: undefined,
	/** 白名单规则名称 */
	title: '',
